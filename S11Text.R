#S11 Text. An R script used to obtain the data for Fig. 6D.
#R script for obtaining the simulation results summarized in Fig. 6D.
#A parameter value for "repr", which determine the relative efficiency of vRNA synthesis by a variant, need to be provided. This script works only when repr <= 1, i.e., only for simulating co-inoculation of wild-type and an equally or less-fit variant.
